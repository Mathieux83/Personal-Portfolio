	...
	return (
		<section className='w-full py-20'>
			<h1 className='heading'>
				My <span className='text-rose-300'>approach</span>
			</h1>
			<div className='my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-6'>
				<Card
					title='Planning & Strategy'
					icon={<AceternityIcon order='Phase 1' />}
					des="We'll discuss to map out your website's goals, target audience, 
          and key functionalities. We'll discuss things like site structure, technologies, 
          navigation, design, and content requirements."
				>
					<CanvasRevealEffect
						animationSpeed={3}
          ...
          once we agree on the plan, I make my best coffee and dive into
          coding.  I'll translate everything into functional code, building your website
          from the ground up, from initial sketches to polished code, I keep you updated
          every step of the way."
				>
					<CanvasRevealEffect
						animationSpeed={3}
						containerClassName='bg-rose-900 rounded-3xl overflow-hidden'
						colors={[
							[255, 166, 158],
							[221, 255, 247],
						]}
				...
				<Card
					...
					des='After we are satisfied with the final rendering of the project, this is the part of the magic public deployment. I proceed to deploy it to the web or, if you desire, I can send you the complete ".zip" file of the project.'
				>
					<CanvasRevealEffect
						animationSpeed={3}
...
const Card = ({
	...
	return (
		<div
			...
			onTouchStart={() => {
				// mark touch and enable hovered state for touch devices
				isTouchRef.current = true;
				setHovered(true);
			}}
			onClick={() => {
				// prevent double-toggle when a touch event already triggered

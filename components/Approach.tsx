...
const AceternityIcon = ({ order }: { order: string }) => {
	return (
		<div>
			<button type="button" className="relative inline-flex overflow-hidden rounded-full p-[1px] ">
